...
FIXTURE_EVENT = {
    ...
    "cv_run_submitted.json": CV_RUN_SUBMITTED,
    "application_submitted.json": APPLICATION_SUBMITTED,
    "outreach_sent.json": OUTREACH_SENT,
    "reply_received.json": REPLY_RECEIVED,
    "chat_session_started.json": CHAT_SESSION_STARTED,
    "chat_cv_matched.json": CHAT_CV_MATCHED,
    "chat_prompts_raised.json": CHAT_PROMPTS_RAISED,
    "chat_application_created.json": CHAT_APPLICATION_CREATED,
}
